...
<?PHP 
    $query = "select * from documentos inner join autores on documentos.id_autor = autores.id_autor inner join categorias on documentos.id_categoria = categorias.id_categoria where tipo='revista'";
