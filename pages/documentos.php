...
<?PHP 
    $query = "select * from documentos inner join autores on documentos.id_autor = autores.id_autor inner join categorias on documentos.id_categoria = categorias.id_categoria where tipo='documento'";
...
<?PHP }?>
   ...
   <?PHP  }
        ...
        echo "<h2 class='text-center'>No hay registros!</h2>";
     }
