...
<?PHP $id_cat = $_GET['id'];
    ...
    $query = "select * from documentos inner join autores on documentos.id_autor = autores.id_autor where id_categoria='$id_cat'";
...
<div class="col">
   ...
   <div class="ml-3">
       ...
       <label><b class="text-info">Categoria: </b><label class="text-capitalize"><?PHP echo $categoria;?></label></label><br>
